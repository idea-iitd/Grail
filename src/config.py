...
class ProgramsDatabaseConfig:
  ...
  num_islands: int = 5 
  reset_period: int = 1 * 60 * 60 # change from 1 hours to 2 hours for ogbg-molpcba, ogbg-molhiv, ogbg-code2, imdb
  submod_reset_time: int = 15 * 60 # change from 15 mins to 40 mins for ogbg-molpcba, ogbg-molhiv, ogbg-code2, imdb
